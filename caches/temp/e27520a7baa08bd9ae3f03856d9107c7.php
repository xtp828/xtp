<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"F:\ddhz\ddhz-admin\xtp/app/admin\view\box\addhouse.html";i:1511022552;s:56:"F:\ddhz\ddhz-admin\xtp/app/admin\view\public\header.html";i:1510924997;s:54:"F:\ddhz\ddhz-admin\xtp/app/admin\view\public\menu.html";i:1510924997;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
            ...
            <form  class="layui-form layui-form-pane" id="formrec" method="post" role="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <button class="btn" lay-submit="" lay-filter="add-role" data-href=<?php echo url('addHouse'); ?>>提交</button>
                    </div>
                </div>
            </form>
        </div>
