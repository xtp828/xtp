<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\product\addproduct.html";i:1510893240;s:63:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\header.html";i:1510893240;s:61:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\menu.html";i:1510893240;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
            ...
            <form  class="layui-form layui-form-pane" id="formrec" method="post" role="form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input class="layui-input" name="name" type="text" placeholder="商品名" required  lay-verify="name" value="">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">价格</label>
                    <div class="layui-input-inline">
                        <input class="layui-input" name="price" type="text" placeholder="价格" required  lay-verify="price" value="">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">产地</label>
                    <div class="layui-input-inline">
                        <input class="layui-input" name="product_area" type="text" placeholder="产地" required  lay-verify="product_area" value="">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <button class="btn" lay-submit="" lay-filter="add-role" data-href=<?php echo url('addProduct'); ?>>提交</button>
                    </div>
                </div>
            </form>
        </div>
