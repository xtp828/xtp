<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\box\addbox.html";i:1510909396;s:63:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\header.html";i:1510893240;s:61:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\menu.html";i:1510893240;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
            ...
            <form  class="layui-form layui-form-pane" id="formrec" method="post" role="form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 100px;">
                        <input class="layui-input" name="number_no" type="text" placeholder="盒子编号"  lay-verify="name" value="<?php echo $number_no; ?>" readonly>
                    </div>
                </div>
