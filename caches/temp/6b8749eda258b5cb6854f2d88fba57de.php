<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\user\adduser.html";i:1505199720;s:63:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\header.html";i:1505199720;s:61:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\menu.html";i:1510732278;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
        ...
        <div class="main">
            ...
            <div class="main_content">
		        ...
		        <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
		              <button class="btn" lay-submit="" lay-filter="add-role" data-href=<?php echo url('adduser'); ?>>提交</button>
                    </div>
		        </div>
				</form>
			</div>
