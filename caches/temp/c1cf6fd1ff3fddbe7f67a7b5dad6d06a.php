<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\menu\index.html";i:1506323385;s:63:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\header.html";i:1505199720;s:61:"E:\phpstudy\WWW\YUNUCMSv1.0.2/app/admin\view\public\menu.html";i:1510732278;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
    ...
    $(document).on('click','.doCache', function () {
		...
		<div class="main">
			...
			<div class="main_content">
				...
				<a class="btn" data-type="doAdd" href="<?php echo url('addrule'); ?>">新增</a>
					...
					<table>
						<thead>
							<tr>
								...
								<th><span>节点</span></th>
								<th width="150"><span>是否启用</span></th>
						...
						<tbody>
			                ...
			                <tr>
			                    ...
			                    <td style="text-align:left;">
			                    	<?php if($v['pid'] == 0): ?>
			                    		<span class="folder-open"><i class="<?php echo $v['css']; ?>"></i></span>
			                    	<?php else: ?>
			                    		<span style="display:inline-block;width:<?php echo $v['leftpin']; ?>px;"></span>├  
			                    ...
			                    <td align="center"><input class="sort" type="number" maxlength="4" data-id="<?php echo $v['id']; ?>" value="<?php echo $v['sort']; ?>"/></td>
			                    <td align="center"><?php echo $v['create_time']; ?></td>
			                    <td align="center">
			                        <a class="btn do-action" data-type="doEdit" data-href="<?php echo url('editrule'); ?>" data-id="<?php echo $v['id']; ?>">编辑</a>
                        			<a class="btn do-action" data-type="doDelOne" data-href="<?php echo url('delrule'); ?>" data-id="<?php echo $v['id']; ?>">删除</a>
			                    </td>
			                </tr>
			                <?php endforeach; endif; else: echo "" ;endif; ?>
						</tbody>
